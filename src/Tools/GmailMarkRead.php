...
class GmailMarkRead implements Tool
{
    ...
    {
        return 'Mark one or more Gmail messages as read. Provide messageIds (comma-separated) for batch operations.';
    }
    ...
    public function handle(Request $request): string
    {
        try {
            ...
            return "{$count} message(s) marked as read.";
        } catch (\Throwable $e) {
