...
class GmailRemoveLabels implements Tool
{
    ...
    {
        return 'Remove labels from one or more Gmail messages. Provide messageIds (comma-separated) for batch operations.';
    }
    ...
    public function handle(Request $request): string
    {
        try {
            ...
            return "{$count} message(s) labels removed successfully.";
        } catch (\Throwable $e) {
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'messageId' => $schema
                ->string()
                ->description('Single message ID to remove labels from.'),
            'messageIds' => $schema
                ->string()
