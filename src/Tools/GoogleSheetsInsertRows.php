...
class GoogleSheetsInsertRows implements Tool
{
    ...
    {
        return 'Insert blank rows into a Google Sheets sheet/tab. Uses 0-based indexing.';
    }
    ...
    public function handle(Request $request): string
    {
        try {
            ...
            return "{$count} row(s) inserted at index {$startIndex} in '{$sheetName}'.";
        } catch (\Throwable $e) {
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'startIndex' => $schema
                ->integer()
                ->description('0-based row index to insert at.')
                ->required(),
            'count' => $schema
                ->integer()
